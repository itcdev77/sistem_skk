    ...
    function submit(x) {
        if (x == 'add') {
            ...
            $.ajax({
                ...
                url: '<?= base_url(); ?>process/view_drone.php',
                dataType: 'json',
...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Report P2H Drone</h1>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <form action="<?= base_url(); ?>/process/ex_drone.php" method="post" target="_blank">
        <div class="row">
            <div class="col-md-2">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th width="100">Nama Drone</th>
                            <th width="100">No Seri Drone</th>
                    ...
                    <tbody>
                        <?php
                        $n = 1;
                        $query = mysqli_query($con, "SELECT * FROM drone ORDER BY idbarang DESC") or die(mysqli_error($con));
        ...
        <div class="modal-content">
            <form action="<?= base_url(); ?>process/act_upd_stts.php" method="post">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center"><b>Silahkan pilih approve untuk setuju dan tolak untuk menolak P2H Drone</b></p>
                ...
                <div class="modal-footer text-center">
                    ...
                    <input class="btn btn-primary float-right" type="submit" name="ubah_stts_drone">
