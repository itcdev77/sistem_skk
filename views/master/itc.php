...
<script>
    function importData() {
        ...
        $.ajax({
            url: '<?= base_url(); ?>process/import_itc.php',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Import Budget ITC</h1>
    </div>
    <!-- DataTales Example -->
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        $query = mysqli_query($con, "SELECT x.*,x1.nama_merek,x2.nama_kategori FROM itc x JOIN merek x1 ON x1.idmerek=x.merek_id JOIN kategori x2 ON x2.idkategori=x.kategori_id ORDER BY x.idbarang DESC") or die(mysqli_error($con));
