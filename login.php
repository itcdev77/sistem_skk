...
if (isset($_POST['cek_login'])) {
    ...
    if (empty($username) && empty($password)) {
        ...
        $user = mysqli_query($con2, "SELECT * FROM user WHERE name='$username'") or die(mysqli_error($con));
                            ...
                            <div class="col-lg-7">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <br>
                                        <center>
                                            <p>Selamat Datang di Sistem Surat Keluar Kendaraan</p>
                                        </center>
